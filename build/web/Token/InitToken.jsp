...
<html>
    <head>
        ...
        <script type="text/javascript">
            changeFavicon("../");
            document.title = token_title_init;
            $(document).ready(function () {
                $('.loading-gif').hide();
                localStorage.setItem("storeAnticsrfTokenList", null);
//                if(localStorage.getItem("LOCAL_PARAM_TOKENLIST") !== null && localStorage.getItem("LOCAL_PARAM_TOKENLIST") !== "null")
//                {
//                    var vParamUrl = getUrlParam("id", "");
//                    if(vParamUrl !== localStorage.getItem("LOCAL_PARAM_TOKENLIST"))
//                    {
...
//                }
            ...
            function ValidateForm(idCSRF)
            {
                ...
                $.ajax({
                    ...
                    data: {
                        idParam: 'inittoken',
                        ID: $("#strID").val(),//document.myname.strID.value,
...
//                                                                            PUSH_TOKEN itemParsePush = oMapperParse.readValue(sValueDefaultJSON, PUSH_TOKEN.class);
//                                                                            strNOTICE_INFO = itemParsePush.PUSH_NOTICE_CONTENT;
//                                                                            strLINK_NOTICE = itemParsePush.PUSH_NOTICE_URL;
//                                                                            strCOLOR_TEXT = itemParsePush.PUSH_NOTICE_TEXT_COLOR;
//                                                                            strCOLOR_BKGR = itemParsePush.PUSH_NOTICE_BGR_COLOR;
                                            }
                                            break;
                                        }
                                    }
        ...
        <div class="x_title">
            ...
            <script>$("#idLblTitleEdits").text(token_title_init);</script>
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    <script>document.getElementById("btnSave").value = token_fm_innit;</script>
                    <%
                        }
                    %>
            ...
            <form name="myname" method="post" class="form-horizontal">
                ...
                <div class="col-sm-6" style="padding-left: 0;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" style="padding-right: 0px;padding-right: 0;">
                ...
                <%
                    ...
                    String dtIS_INITIALIZE = "";
                    String userIS_INITIALIZE = "";
                    String desIS_INITIALIZE = "";
                    String attrIS_INITIALIZE = "";
                    String stateIS_INITIALIZE = "";
                    int itateIS_INITIALIZE = 0;
                    ...
                    if (rsFunction[0].length > 0) {
                        ...
                        {
                            if(rsFunction[0][j].TOKEN_ATTR_TYPE_ID == Definitions.CONFIG_TOKEN_ATTR_TYPE_ID_INITIALIZE)
                            {
                                IS_INITIALIZE = true;
                                dtIS_INITIALIZE = rsFunction[0][j].CREATED_DT;
                                userIS_INITIALIZE = rsFunction[0][j].CREATED_BY;
                                desIS_INITIALIZE = rsFunction[0][j].TOKEN_ATTR_TYPE_DESC;
                                attrIS_INITIALIZE = String.valueOf(rsFunction[0][j].TOKEN_ATTR_ID);
                                itateIS_INITIALIZE = rsFunction[0][j].TOKEN_ATTR_STATE;
                                stateIS_INITIALIZE = EscapeUtils.CheckTextNull(rsFunction[0][j].TOKEN_ATTR_STATE_DESC);
                            }
                        }
                    }
                    int j=0;
                ...
                <fieldset class="scheduler-border">
                    ...
                    <table class="table table-striped projects" id="mtToken">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><%= j%></td>
                                <td><%= desIS_INITIALIZE%></td>
                                <td><%= stateIS_INITIALIZE%></td>
                                <td><%= dtIS_INITIALIZE%></td>
                                <td><%= userIS_INITIALIZE%></td>
                                <%
                                    if(CommonFunction.CheckRoleFuncValid(Definitions.CONFIG_ROLE_PROPERTIES_TOKEN_DECLINED, Definitions.CONFIG_ROLE_ATTRIBUTE_TYPE_TOKEN_REQUUEST, sessFunctionToken) == true) {
                                %>
                                <td>
                                    <%
                                        if(itateIS_INITIALIZE == Definitions.CONFIG_TOKEN_STATE_ID_PENDDING) {
                                    %>
                                    <a id="idLblTitleDecline" style="cursor: pointer;" onclick="popupCancel(<%=attrIS_INITIALIZE%>);" class="btn btn-info btn-xs"></a>
                                    <script>
                                        $("#idLblTitleDecline").append('<i class="fa fa-pencil"></i>' + global_fm_button_decline);
                                    </script>
                                    <%
                                        } else if(itateIS_INITIALIZE == Definitions.CONFIG_TOKEN_STATE_ID_APPROVED) {
