...
<html>
    <head>
        ...
        <script type="text/javascript">
            changeFavicon("../");
            document.title = token_title_changesopin;
...
//                            }
        ...
        <div class="x_title">
            ...
            <script>$("#idLblTitleEdits").text(token_title_changesopin);</script>
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    <script>document.getElementById("btnSave").value = token_fm_change;</script>
                    <%
                        }
                    %>
