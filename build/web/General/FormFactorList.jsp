<%-- 
    Document   : FormFactorList
    Created on : Feb 5, 2021, 4:49:15 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <script language="javascript">
            changeFavicon("../");
            document.title = formfactor_title_list;
            $(document).ready(function () {
                localStorage.setItem("LOCAL_PARAM_FORMFACTORLIST", null);
            });
            function popupEdit(id)
            {
                $('body').append('<div id="over"></div>');
                $(".loading-gif").show();
                $('#contentEdit').load('FormFactorEdit.jsp', {id:id}, function () {
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="top_nav">
                    ...
                    <script>
                        document.getElementById("idNameURL").innerHTML = formfactor_title_list;
                    </script>
                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title" style="border-bottom: 0 solid #E6E9ED;margin-bottom: 0px;">
                                        <h2><i class="fa fa-list-ul"></i> <script>document.write(formfactor_title_table);</script></h2>
                                    ...
                                    <%
                                        PKI_FORMFACTOR[][] rsPgin = new PKI_FORMFACTOR[1][];
                                        try {
                                            ...
                                            if (session.getAttribute("SessRefreshFormFactor") != null) {
                                                session.setAttribute("SessRefreshFormFactor", null);
                                                int ss = db.S_BO_PKI_FORMFACTOR_TOTAL();
                                                if (ss > 0) {
                                                    if (session.getAttribute("IPageNoSessListFormFactor") != null) {
                                                        String sPage = (String) session.getAttribute("IPageNoSessListFormFactor");
                                                        iPagNo = Integer.parseInt(sPage);
                                                    }
                                                    if (session.getAttribute("ISwRwsSessListFormFactor") != null) {
                                                        String sSumPage = (String) session.getAttribute("ISwRwsSessListFormFactor");
                                                        iSwRws = Integer.parseInt(sSumPage);
                                                    }
                                                    if (session.getAttribute("NumPageSessListFormFactor") != null) {
                                                        String sNoPage = (String) session.getAttribute("NumPageSessListFormFactor");
                                                        iPaNoSS = Integer.parseInt(sNoPage);
                                                    }
                                                    session.setAttribute("IPageNoSessListFormFactor", String.valueOf(iPagNo));
                                                    session.setAttribute("ISwRwsSessListFormFactor", String.valueOf(iSwRws));
                                                    db.S_BO_PKI_FORMFACTOR_LIST(rsPgin, iPagNo, iSwRws, sessLanguageGlobal);
                                                }
                                                iTotRslts = ss;
                                            }
                                            else
                                            {
                                                session.setAttribute("NumPageSessListFormFactor", null);
                                                session.setAttribute("IPageNoSessListFormFactor", null);
                                                session.setAttribute("ISwRwsSessListFormFactor", null);
                                                if (hasPaging != true) {
                                                    session.setAttribute("CountListFormFactor", null);
                                                }
                                                int ss = 0;
                                                if ((session.getAttribute("CountListFormFactor")) == null) {
                                                    ss = db.S_BO_PKI_FORMFACTOR_TOTAL();
                                                    session.setAttribute("CountListFormFactor", String.valueOf(ss));
                                                } else {
                                                    String sCount = (String) session.getAttribute("CountListFormFactor");
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="table-responsive">
                                                <table id="idTableList" class="table table-bordered table-striped projects">
                                                    ...
                                                    <th><script>document.write(formfactor_fm_code);</script></th>
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            session.setAttribute("NumPageSessListFormFactor", String.valueOf(iPaNoSS));
