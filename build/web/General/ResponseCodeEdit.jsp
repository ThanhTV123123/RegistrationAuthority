<%-- 
    Document   : ResponseCodeEdit
    Created on : Apr 24, 2018, 5:46:33 PM
    Author     : THANH-PC
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            changeFavicon("../");
            document.title = response_title_edit;
            ...
            function ValidateForm(idCSRF) {
                ...
                $.ajax({
                    ...
                    success: function (html)
                    {
                        ...
                        if (myStrings[0] === "0")
                        {
                            funSuccAlert(response_succ_edit, "ResponseCodeList.jsp");
                        }
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><i class="fa fa-list-ul"></i> <script>document.write(response_title_edit);</script></h2>
                                    ...
                                    <div class="x_content">
                                        <%
                                            RESPONSE_CODE[][] rs = new RESPONSE_CODE[1][];
                                            try {
                                                String ids = EscapeUtils.CheckTextNull(request.getParameter("id"));
                                                if (EscapeUtils.IsInteger(ids) == true) {
                                                    db.S_BO_RESPONSE_CODE_DETAIL(EscapeUtils.escapeHtml(ids), rs);
                                                    if (rs[0].length > 0) {
