<%-- 
    Document   : CertificateShareRenew
    Created on : Dec 12, 2019, 5:46:02 PM
    Author     : USER
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function UpdateForm(idCSRF, isCA) {
                ...
                if (!JSCheckEmptyField($("#USER_RENEWAL").val()))
                {
                    $("#USER_RENEWAL").focus();
                    funErrorAlert(policy_req_empty_choose + global_fm_user_create);
                    return false;
                }
                    ...
                    success: function (html) {
                        ...
                        if (arr[0] === "0")
                        {
                            ...
                            if(arr[2] === "0")
                            {
                                ...
                                localStorage.setItem("LOCAL_PARAM_CERTSAHRELIST", arr[1]);
                                if(isCA === JS_IS_WHICH_ABOUT_CA_ICA) {
                                    funSuccAlert(owner_succ_dispose, 'CertificateShareList.jsp');
                                } else {
                                    swal({
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select name="CERTIFICATION_AUTHORITY_RENEW" id="CERTIFICATION_AUTHORITY_RENEW"
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select id="CERTIFICATION_DURATION" name="CERTIFICATION_DURATION" class="form-control123"
                                    ...
                                    <%
                                        ...
                                        db.S_BO_CA_GET_DURATION_COMBOBOX_RENEWAL(sFristCA, sFristCerPurpose, String.valueOf(intPKI_FORMFACTOR_ID),
                                            sessLanguageGlobal, rsDuration);
...
//                            if(rs[0][0].SHARED_MODE == true) {
//                                if(!String.valueOf(rs[0][0].BRANCH_ID).equals(SessUserAgentID)) {
//                                    sBranchIDRequest = SessUserAgentID;
//                                    sBranchDescRequest = session.getAttribute("SessAgentName").toString().trim();
//                                    sUserIDRequest = session.getAttribute("UserID").toString().trim();
//                                    strCREATED_BY = session.getAttribute("pUserID").toString().trim() + "(" + session.getAttribute("sesFullname").toString().trim() + ")";
//                                }
//                            }
...
//                            return false;
                ...
                <fieldset class="scheduler-border" style="clear: both;">
                    ...
                    <div style="padding: 10px 0 10px 0;" id="idDiv<%= sName%>" class="table-responsive">
                        <table id="idTable<%= sName%>" class="table table-bordered table-striped projects" style="margin-bottom: 10px;">
                            <thead>
