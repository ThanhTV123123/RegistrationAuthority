    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function popupPrint(id, idCSRF)
            {
                ...
                {
//                    var vValuePhoneNum = trimAllString($("#BRANCH_PHONE").val());
...
//                    });
                ...
                {
//                    var vValuePhoneNum1 = trimAllString($("#TO_PHONE").val());
//                    var cChatStatusNum1 = getCheckStatusPhone(vValuePhoneNum1);
//                    cChatStatusNum1.done(function(msg) {
//                        var s = sSpace(msg).split('#');
//                        if(s[0] !== "0")
//                        {
//                            $("#TO_PHONE").focus();
...
//                                $("#idLblNoteAgentName").text(global_fm_require_label);
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-sm-6" style="padding-left: 0;">
                            ...
                            <script>$("#idLblTitleCMND").text(global_fm_CMND + "/" + global_fm_HC + "/" + global_fm_CitizenId);</script>
                        </div>
