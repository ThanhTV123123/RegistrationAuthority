<%-- 
    Document   : PrintReissueCert
    Created on : May 27, 2020, 10:57:25 AM
    Author     : USER
--%>
...
//                        }
//                        strCMND = EscapeUtils.CheckTextNull((rs[0][0].P_ID));
//                        if("".equals(strCMND)) {
//                            strCMND = EscapeUtils.CheckTextNull((rs[0][0].P_EID));
//                        }
//                        if("".equals(strCMND)) {
//                            strCMND = EscapeUtils.CheckTextNull((rs[0][0].PASSPORT));
//                        }
        ...
        <div class="x_title">
            ...
            <script>$("#idLblTitlePrintEdits").text(certlist_title_print_reissue_revoke);</script>
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="PRINT_ADDRESS" id="PRINT_ADDRESS" value="<%=strADDRESS%>" class="form-control123"/>
                            </div>
                        </div>
                        <script>$("#idLblTitlePhone").text(global_fm_address);</script>
                    </div>
                    <!--<div class="col-sm-6" style="padding-left: 0;clear: both;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="PRINT_REPRESENTATIVE" id="PRINT_REPRESENTATIVE" class="form-control123">
                            </div>
                        </div>
