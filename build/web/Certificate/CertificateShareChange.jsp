<%-- 
    Document   : CertificateShareChange
    Created on : Dec 12, 2019, 5:46:53 PM
    Author     : USER
--%>
            ...
            function UpdateForm(idCSRF)
            {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        if (arr[0] === "0")
                        {
                            localStorage.setItem("EDIT_CERTSHARE_CHANGE", $("#sID").val());
                            if (arr[2] === "1")
                            {
                            ...
                            funSuccAlert(certlist_succ_changeinfo, "CertificateShareList.jsp");
                        }
...
//                                }
                        ...
                        if (isAccessAgencyPage == true) {
                            ...
                            {
                                cartToken = CommonFunction.getDNSListForSSL(sPROPERTIES);
                                session.setAttribute("sessDNSNameForSSL_Change", cartToken);
                            }*/
                            int intDuration = 0;
