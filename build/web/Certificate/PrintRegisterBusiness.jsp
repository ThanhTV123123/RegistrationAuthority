<%-- 
    Document   : PrintRegisterBusiness
    Created on : Aug 5, 2018, 9:25:13 PM
    Author     : THANH-PC
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function popupPrint(id, idCSRF)
            {
                ...
                if(varCALoad !== JS_IS_WHICH_ABOUT_CA_WINCA) {
        ...
        <%                                        CERTIFICATION[][] rs = new CERTIFICATION[1][];
            ...
            try {
                ...
                if (EscapeUtils.IsInteger(ids) == true) {
                    ...
                    if (rs[0].length > 0) {
                        int intPURPOSE_ID = rs[0][0].CERTIFICATION_PURPOSE_ID;
...
//                            }
                        ...
                        String sViewReadOnlyEnter = "readonly";
                        if(intPURPOSE_ID == Definitions.CONFIG_CERTTYPE_ID_DEVICE) {
                            sViewReadOnlyEnter = "";
                        }
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="INFO_NAME" id="INFO_NAME" <%=sViewReadOnlyEnter%> value="<%= EscapeUtils.escapeHtmlDN(strCOMPANY)%>" class="form-control123">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="INFO_ORGANI" id="INFO_ORGANI" <%=sViewReadOnlyEnter%> value="<%= strORGANI %>" class="form-control123">
                            </div>
                        </div>
...
<!--                                                    <div class="col-sm-4" style="padding-left: 0; padding-top: 10px;">
                            <input TYPE="checkbox" id="CheckDKDN" name="CheckDKDN" onchange="clickCheckChoose();" checked />
                            &nbsp;&nbsp;<label class="control-label123"><script>document.write(global_fm_checkbox_gcndk);</script></label>
                        </div>
                        <div class="col-sm-4" style="padding-left: 0; padding-top: 10px;">
                            <input TYPE="checkbox" id="CheckDT" name="CheckDT" onchange="clickCheckChoose();" />
                            &nbsp;&nbsp;<label class="control-label123"><script>document.write(global_fm_checkbox_GPDT);</script></label>
                        </div>
                        <div class="col-sm-4" style="padding-left: 0; padding-top: 10px;">
                            <input TYPE="checkbox" id="CheckTL" name="CheckTL" onchange="clickCheckChoose();" />
                            &nbsp;&nbsp;<label class="control-label123"><script>document.write(global_fm_checkbox_QDTL);</script></label>
                        </div>-->
...
//                                                    function clickCheckChoose()
//                                                    {
//                                                        if ($("#CheckDKDN").is(':checked'))
//                                                        {
//                                                            $("#CheckDKDN").bootstrapSwitch('setState', true);
//                                                            $("#CheckDT").bootstrapSwitch('setState', false);
//                                                            $("#CheckTL").bootstrapSwitch('setState', false);
////                                                            $("#CheckDKDN").bootstrapSwitch('disabled',false);
////                                                            $("#CheckDT").bootstrapSwitch('disabled',true);
////                                                            $("#CheckTL").bootstrapSwitch('disabled',true);
//                                                        }
//                                                        if ($("#CheckDT").is(':checked'))
//                                                        {
//                                                            $("#CheckDT").bootstrapSwitch('setState', true);
//                                                            $("#CheckDKDN").bootstrapSwitch('setState', false);
//                                                            $("#CheckTL").bootstrapSwitch('setState', false);
//                                                        }
...
//                                                    }
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoID" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoOrganiDate" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoOrganiGrant" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoTaxCode" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="INFO_TAXCODE" value="<%= strMSTORMNS %>" <%=sViewReadOnlyEnter%> id="INFO_TAXCODE" class="form-control123">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoAddress" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoEmail" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleInfoPhone" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;<%=isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_WINCA) && rs[0][0].CERTIFICATION_ATTR_TYPE_ID == Definitions.CONFIG_CERTIFICATION_ATTR_TYPE_ID_CHANGEINFO ? "display:none;":"" %>">
                        <div class="form-group">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;<%=isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_WINCA)?"display:none;":"" %>">
                        <div class="form-group">
                            <label class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;">
                                <label id="idLblTitleFullnamePrint"></label>
                                <label class="CssRequireField" id="idLblNoteFullnamePrint"></label>
                            </label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                        ...
                        <script>
                            ...
                            $("#idLblTitleFullnamePrint").text(global_fm_fullname);
                            $("#idLblNoteFullnamePrint").text(global_fm_require_label);
                        </script>
                    </div>
                    <div class="col-sm-6" style="padding-left: 0;<%=isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_WINCA)?"display:none;":"" %>">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="CONTACT_PHONE" readonly value="<%= strPHONE_CONTACT %>" id="CONTACT_PHONE"
                                    class="form-control123" onblur="autoTrimTextField('CONTACT_PHONE', this.value);"/>
                            </div>
                        </div>
