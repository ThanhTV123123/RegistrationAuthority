<%-- 
    Document   : ChangeCertView
    Created on : Jul 11, 2018, 2:08:07 PM
    Author     : THANH-PC
--%>
...
<%
    ...
    String isUIDChangeEnabled = LoadParamSystem.getParamStart(Definitions.CONFIG_UID_CHANGE_INFO_BO_ENABLED);
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('.loading-gif').hide();
                $("#idLblTitleEdits").text(certlist_title_changeinfo);
            ...
            function UpdateForm(idCSRF, isCA)
            {
                ...
                console.log("vSTR_COMPONENT_DN_VALUE_ENTERPRISE_ID: " + vSTR_COMPONENT_DN_VALUE_ENTERPRISE_ID);
                console.log("vSTR_COMPONENT_DN_VALUE_PERSONAL_ID " + vSTR_COMPONENT_DN_VALUE_PERSONAL_ID);
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        BRANCH_ID: $("#AGENT_NAME_CHANGE").val(),
                        CREATE_USER: $("#USER_CHANGE").val(),
                    ...
                    success: function (html) {
                        ...
                        if (arr[0] === "0")
                        {
                            localStorage.setItem("EDIT_RENEWCERT_CHANGE", $("#sID").val());
                            if (arr[2] === "1")
                            {
                            ...
                            funSuccAlert(certlist_succ_changeinfo, "RenewCertList.jsp");
                ...
                if (EscapeUtils.IsInteger(ids) == true) {
                    ...
                    if (rs[0].length > 0) {
                        ...
                        if (isAccessAgencyPage == true) {
                            ...
                            // GET DNS LIST for SSL
                            session.setAttribute("sessDNSNameForSSL_Change", null);
        ...
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    %>
                    <input type="button" id="btnApprove" class="btn btn-info" onclick="UpdateForm('<%=anticsrf%>', '<%=LoadParamSystem.getParamStart(Definitions.CONFIG_IS_WHICH_ABOUT_CA)%>');" />
                    <script>
                        $(document).ready(function () {
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select name="CERTIFICATION_AUTHORITY" id="CERTIFICATION_AUTHORITY" class="form-control123"
                                    ...
                                    <option value="<%=String.valueOf(rsCA[0][i].ID)
                                        + "###" + EscapeUtils.CheckTextNull(rsCA[0][i].CERTIFICATION_AUTHORITY_CORECA_SUBJECT)%>"
                                        <%= rsCA[0][i].ID == rs[0][0].CERTIFICATION_AUTHORITY_ID ? "selected" : "" %>><%=rsCA[0][i].REMARK%></option>
                                    <%
                                                }
                                            } else {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select name="CERTIFICATION_PURPOSE" id="CERTIFICATION_PURPOSE" class="form-control123" disabled>
                                    ...
                                    %>
                                    <option value="<%=String.valueOf(rsPurpose[0][i].ID)%>" <%= rsPurpose[0][i].ID == rs[0][0].CERTIFICATION_PURPOSE_ID ? "selected" : "" %>><%=rsPurpose[0][i].REMARK%></option>
                                    <%
                                            }
                                        }
                                    %>
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select id="CERTIFICATION_DURATION" name="CERTIFICATION_DURATION" class="form-control123" disabled>
                                    <%
                                        ...
                                        db.S_BO_CA_GET_DURATION_COMBOBOX_BY_TYPE(sFristCA, sFristCerPurpose, String.valueOf(intPKI_FORMFACTOR_ID), Definitions.CONFIG_CERTIFICATION_ATTR_TYPE_ID_CHANGEINFO, sessLanguageGlobal, rsDuration);
...
//                                if(rsPolicy1.NAME.equals(Definitions.CONFIG_POLICY_BO_REVOKE_CERTIFICATE_AFTER_REISSUE_CHANGINFO))
                                if(rsPolicy1.NAME.equals(Definitions.CONFIG_POLICY_FO_REVOKE_CERTIFICATE_AFTER_CHANGEINFO))
                                {
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        <div class="form-group">
                            <label id="idLblTitleAgentChange" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;">
                            </label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select name="AGENT_NAME_CHANGE" id="AGENT_NAME_CHANGE" class="form-control123"
                                    onchange="LOAD_BACKOFFICE_USER(this.value, '<%= anticsrf%>');" <%=idDisabledAgentUser%>>
                                    <%
                        ...
                        <script>$("#idLblTitleAgentChange").text(global_fm_Branch);</script>
                    </div>
                    <div class="col-sm-6" style="padding-left: 0px;">
                        <div class="form-group">
                            <label id="idLblTitleUserChange" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;">
                            </label>
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <select name="USER_CHANGE" id="USER_CHANGE" class="form-control123" <%=idDisabledAgentUser%>>
                                    <%
                        ...
                        <script>$("#idLblTitleUserChange").text(global_fm_user_create);</script>
                    </div>
                    <script>
                        function LOAD_BACKOFFICE_USER(objAgency, idCSRF)
                        {
                            $.ajax({
                                ...
                                success: function (html)
                                {
                                    if (html.length > 0)
                                    {
                                        var cbxUSER = document.getElementById("USER_CHANGE");
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <label class="switch" for="FO_DELETE_CERT_WHEN_REVOKE">
                                    ...
                                    <div id="idClassFO_DELETE_CERT_WHEN_REVOKE" class="slider round"></div>
                                </label>
                            </div>
                        </div>
                        <script>
                    ...
                    %>
                    <%
                        String sShowRevokeOldCert = "";
                    %>
                    <div class="col-sm-6" style="padding-left: 0;display: <%=sShowRevokeOldCert%>">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <label class="switch" for="idCheckRevoked">
                                    <input type="checkbox" name="idCheckRevoked" id="idCheckRevoked" onclick="onCheckRevoked();"
                                        <%= "1".equals(boCheckRevoked) ? "checked" : "" %> <%= actionRevokeOldCertEnabled ? "" : "disabled" %>/>
                                    <div class="slider round <%= actionRevokeOldCertEnabled ? "" : "disabled" %>"></div>
                                </label>
                            </div>
                        </div>
                        <script>
                            $("#idLblTitleRevoked").text(regiscert_fm_check_revoke);
                            $(document).ready(function () {
                                if ($("#idCheckRevoked").is(':checked'))
                                {
                                    var varCALoad = '<%=isCALoad%>';
                                    if(varCALoad !== JS_IS_WHICH_ABOUT_CA_NC) {
                                        $("#FO_DELETE_CERT_WHEN_REVOKE").attr("disabled", true);
                                        $('#FO_DELETE_CERT_WHEN_REVOKE').prop('checked', true);
                                        $("#idClassFO_DELETE_CERT_WHEN_REVOKE").addClass("disabled");
                                    }
                                }
                            });
                            function onCheckRevoked() {
                                if ($("#idCheckRevoked").is(':checked')) {
                                    var varCALoad = '<%=isCALoad%>';
                                    if(varCALoad !== JS_IS_WHICH_ABOUT_CA_NC) {
                                        $("#FO_DELETE_CERT_WHEN_REVOKE").attr("disabled", true);
                                    ...
                                    $("#FO_DELETE_CERT_WHEN_REVOKE").attr("disabled", false);
                                    $("#idClassFO_DELETE_CERT_WHEN_REVOKE").removeClass("disabled");
                                }
                            }
                        </script>
                    </div>
                    ...
                    <%
                        String sJSON = "";
                        CERTIFICATION_PURPOSE[][] rsPURPOSE = new CERTIFICATION_PURPOSE[1][];
                        db.S_BO_CERTIFICATION_PURPOSE_DETAIL_BY_CERTIFICATION_ATTR_TYPE(String.valueOf(rs[0][0].CERTIFICATION_PURPOSE_ID), Definitions.CONFIG_CERTIFICATION_ATTR_TYPE_CODE_CHANGEINFO, rsPURPOSE);
                        if(rsPURPOSE[0].length > 0)
                        {
                        ...
                        function LoadFileManage(idPurpose)
                        {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    idPurpose: idPurpose,
                                        attrTypeID: JS_STR_CERTIFICATION_ATTR_TYPE_ID_CHANGEINFO
                                },
                                cache: false,
                                success: function (html) {
                                    if (html.length > 0)
                                ...
                                <div class="col-sm-13" style="padding-left: 0;">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2" style="padding-right: 0px;">
                                            <input type="button" id="btnSaveDNS" class="btn btn-info" onclick="addDNSNew('sessDNSNameForSSL_Change');"/>
                                            <script>
                                   ...
                                   <tbody id="idTBodyDNS">
                                       ...
                                       %>
                                        <tr>
                                           ...
                                           <td>
                                               <a id="idLinkDNSDelete<%=j%>" style="cursor: pointer;" class="btn btn-info btn-xs" onclick="DeleteDNSNew('<%= mhDNS.DNS_NAME%>', 'sessDNSNameForSSL_Change');"></a>
                        ...
                        function LOAD_PROFILE_BY_FORMFACTOR(objCA, objPurpose, objFactor, idCSRF)
                        {
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    idFactor: objFactor,
                                    idAttrType: JS_STR_CERTIFICATION_ATTR_TYPE_ID_CHANGEINFO,
                                    CsrfToken: idCSRF
                                },
                                cache: false,
                                success: function (html)
                                {
                                    if (html.length > 0)
                                    {
                                        ...
                                        if (obj[0].Code === "0")
                                        {
                                            ...
                                            var idiFORMFACTORDefault = '<%=intPKI_FORMFACTOR_ID%>';
                                            var idPURPOSE_IDDefault = '<%=intCERTIFICATION_PURPOSE_ID%>';
                                            var idCA_IDDefault = '<%=rs[0][0].CERTIFICATION_AUTHORITY_ID%>';
                                            for (var i = 0; i < obj.length; i++) {
                                                if(idiFORMFACTORDefault === objFactor && idPURPOSE_IDDefault === objPurpose && idCA_IDDefault === objCA)
                                                {
                                                    idProfileDefault = '<%=strCERTIFICATION_PROFILE_ID%>';
                                                } else {
...
<!--                                CERT DOWNLOAD
                    ...
                    <script>
                        ...
                        function LoadFormDNForPersonalCommon(idCertType)
                        {
                            $.ajax({
                                type: "post",
                                url: "../JSONCommon",
                                ...
                                success: function (html)
                                {
                                    if (html.length > 0)
                                    {
                                        ...
                                        if (obj[0].Code === "0")
                                        {
                                            ...
                                            var caUIDChangeEnabled = '<%=isUIDChangeEnabled%>';
                                            var vDNFromDB = document.getElementById("idHiddenDN").value;
                                            var editPrefix = "disabled";
                                            if(caUIDChangeEnabled === "1"){
                                                editPrefix = "";
                                            }
                                                ...
                                                if(isRepresenseEnabled === "1"){
                                                    vContentButton_MST_Radio = "<div class='col-sm-13' style='margin-bottom:0px;padding-left: 0px;'>\n\
                                                        ...
                                                        vContentButton_MST_Radio = vContentButton_MST_Radio + '<select name="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_COMPANY_CBX_ID
                                                            +'" id="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_COMPANY_CBX_ID+'" '+editPrefix+' class="form-control123" onlick="OnChangeComboboxMST();"></select>';
                                                        vContentButton_MST_Radio = vContentButton_MST_Radio + "</div><div class='col-sm-6' style='padding-left: 0px;margin-left: 0px;margin-right:0px;padding-right:0;'><input class='form-control123' type='text' "+editPrefix+" id='" + JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_COMPANY_INPUT_ID + "' />";
                                                    ...
                                                    vContentButton_MST_Radio = vContentButton_MST_Radio + '<select name="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_COMPANY_CBX_ID
                                                        +'" id="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_COMPANY_CBX_ID+'" '+editPrefix+' class="form-control123" onlick="OnChangeComboboxMST();"></select>';
                                                    vContentButton_MST_Radio = vContentButton_MST_Radio + "</div><div class='col-sm-9' style='padding-right: 0px;'><input class='form-control123' type='text' "+editPrefix+" id='" + JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_COMPANY_INPUT_ID + "' />";
                                            ...
                                            if(booHasUIDPersonal === true)
                                            {
                                                ...
                                                if(isRepresenseEnabled === "1") {
                                                    ...
                                                    vContentButton_CMND_Radio = vContentButton_CMND_Radio + '<select name="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_PERSONAL_CBX_ID
                                                        +'" id="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_PERSONAL_CBX_ID+'" '+editPrefix+' class="form-control123"></select>';
                                                    ...
                                                    vContentButton_CMND_Radio = vContentButton_CMND_Radio + '<select name="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_PERSONAL_CBX_ID
                                                        +'" id="'+JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_PERSONAL_CBX_ID+'" '+editPrefix+' class="form-control123"></select>';
                                                    vContentButton_CMND_Radio = vContentButton_CMND_Radio + "</div><div class='col-sm-9' style='padding-right: 0px;'><input class='form-control123' "+editPrefix+" type='text' id='" + JS_STR_COMPONENT_DN_VALUE_UID_COMBOBOX_LIST_PERSONAL_INPUT_ID + "' />";
                                            ...
                                            if(vSanContent !== "") {
                                                ...
                                                var vFormFactorInner = '<%= String.valueOf(intPKI_FORMFACTOR_ID)%>';
                                                if(vFormFactorInner === JS_STR_PKI_FORMFACTOR_ID_ESIGNCLOUD) {
...
//                                                        }
                                            ...
                                            {
                                                if('<%= intCERTIFICATION_PURPOSE_ID%>' === JS_STR_CERTIFICATION_PURPOSE_ID_ENTERPRISE
                                                    || '<%= intCERTIFICATION_PURPOSE_ID%>' === JS_STR_CERTIFICATION_PURPOSE_ID_CODE_SIGNING)
                                                {
                                                    var idCNTemp="";
                                                    var idOTemp = "";
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    <%
                        if(CommonFunction.CheckRoleFuncValid(Definitions.CONFIG_ROLE_PROPERTIES_CERT_CHANGE_INFO,Definitions.CONFIG_ROLE_ATTRIBUTE_TYPE_CERT_REQUUEST, sessFunctionCert) == true) {
                    %>
                    <input type="button" id="btnApproveFooter" class="btn btn-info" onclick="UpdateForm('<%=anticsrf%>', '<%=LoadParamSystem.getParamStart(Definitions.CONFIG_IS_WHICH_ABOUT_CA)%>');" />
                    <script>document.getElementById("btnApproveFooter").value = global_fm_button_add_simple;</script>
                    <%
                        }
                    %>
                    <%
