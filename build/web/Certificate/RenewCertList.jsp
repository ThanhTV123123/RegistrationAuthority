                                                ...
                                                <%
                                                    ...
                                                    if(rsPgin[0].length > 0) {
                                                        ...
                                                        if(isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_NC)){
                                                            String userNameLogin = session.getAttribute("sUserID").toString().trim();
                                                            if(userNameLogin.equals("ttca") || userNameLogin.equals("ttca1")) {
                                                                isExportEnable = false;
                                                            }
                                                        }
                                                    }
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="table-responsive">
                                            <table id="idTableList" class="table table-bordered table-striped projects">
                                                ...
                                                <th style="display: <%= isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_ICA) ? "" : "none"%>"><script>document.write(cert_fm_type_request);</script></th>
                                                ...
                                                <%
                                                    if(isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_ICA) && SessAgentID.equals(Definitions.CONFIG_AGENT_ROOT)) {
                                                        if(!SessRoleID.equals(Definitions.CONFIG_ROLE_ID_CA_SURVEYOR)) {
                                                %>
                                                <th><script>document.write(global_fm_phone_contact_grid);</script></th>
                                                <th><script>document.write(global_fm_email_contact_grid);</script></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display: <%= isCALoad.equals(Definitions.CONFIG_IS_WHICH_ABOUT_CA_ICA) ? "" : "none"%>"><%= EscapeUtils.CheckTextNull(temp1.CERTIFICATION_ATTR_TYPE_DESC) %></td>
