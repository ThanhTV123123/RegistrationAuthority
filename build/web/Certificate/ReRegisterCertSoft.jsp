<%-- 
    Document   : ReRegisterCertSoft
    Created on : Nov 15, 2018, 9:54:22 AM
    Author     : THANH-PC
--%>
...
//                var sTempIS_MENU_LINK_SET_NO = $("#IsCheckCSR").bootstrapSwitch("state");
                ...
                $.ajax({
                    ...
                    data: {
                        idParam: 're-registrationcertsoft',
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <form name="myname" method="post" class="form-horizontal">
                                            ...
                                            %>
                                            <div class="form-group" style="padding: 0px 0px 10px 0px;margin: 0;display: <%= sViewTOKEN_SN%>">
                                            ...
                                            <div class="form-group" style="padding: 10px 0px 0 0px;margin: 0;">
                                                <label class="control-label123"><script>document.write(global_fm_email_contact_signserver);</script></label>
                                                <label class="CssRequireField"><script>document.write(global_fm_require_label);</script></label>
                                            ...
                                            <div class="form-group" style="padding: 10px 0px 0 0px;margin: 0;">
                                                ...
                                                <select id="CERTIFICATION_PURPOSE" name="CERTIFICATION_PURPOSE" class="form-control123"
                                                    ...
                                                    <%
                                                        ...
                                                        db.S_BO_CA_GET_CERTIFICATION_PURPOSE_COMBOBOX_SOFT_TOKEN(sFristCA, sessLanguageGlobal, rsCertPro);
                                            ...
                                            %>
                                            <div class="form-group" style="padding: 10px 0px 0 0px;margin: 0;display: <%= sViewPUSH_NOTICE_ENABLED%>">
                                                <input TYPE="checkbox" <%= "1".equals(pPUSH_NOTICE_ENABLED) ? "checked" : ""%> id="PUSH_NOTICE_ENABLED" name="PUSH_NOTICE_ENABLED" />
                                                &nbsp;&nbsp;
                                                <label class="control-label123"><script>document.write(cert_fm_push_notice);</script></label>
                                            </div>
                                            <div class="form-group" style="padding: 10px 0px 0px 0px;margin: 0;">
<!--                                                <label class="control-labelcheckbox"><script>document.write(global_fm_choose_csr);</script></label>&nbsp;&nbsp;
