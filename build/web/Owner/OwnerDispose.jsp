<%-- 
    Document   : OwnerDispose
    Created on : Nov 1, 2019, 5:10:33 PM
    Author     : USER
--%>
...
<html>
    ...
    <body>
        ...
        <div class="x_title">
            ...
            <script>$("#idLblTitleEdits").text(owner_title_dispose);</script>
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    <%
                        ...
                        {
                    %>
                    <input type="button" id="btnApprove" class="btn btn-info" onclick="formDispose('<%= rs[0][0].ID%>', '<%=anticsrf%>');" />
                    <script>document.getElementById("btnApprove").value = global_fm_button_add;</script>
                    <%
                        }
                    %>
                    <script>
                        function formDispose(id, idCSRF)
                        {
...
<!--                <div class="col-sm-6" style="padding-left: 0;">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7" style="padding-right: 0px;">
                            <input class="form-control123" <=sDisabledEdit%> value="<= EscapeUtils.CheckTextNull(rs[0][0].MESSAGING_QUEUE_STATE_DESC)%>" id="QUEUE_STATE" name="QUEUE_STATE">
                        </div>
                    </div>
                    <script>
...
<!--                <div class="col-sm-12" style="padding-left: 0;">
                    <div class="form-group">
                        <label id="idLblTitleRevokeReason" class="control-label col-sm-2" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;"></label>
                        <div class="col-sm-10" style="padding-right: 0px;">
                            <input class="form-control123" maxlength="500" id="RevokeReason" name="RevokeReason">
                        </div>
                    </div>
                    <script>
                        $("#idLblTitleRevokeReason").text(global_fm_dipose_desc);
                    </script>
                </div>-->
                <div class="form-group" style="padding: 0px 0px 10px 0px;margin: 0;">
                    <label id="idLblTitleRevokeReason" class="control-label123"></label>
                    <input class="form-control123" maxlength="500" id="RevokeReason" name="RevokeReason">
                    <script>
                        $("#idLblTitleRevokeReason").text(global_fm_dipose_desc);
                    </script>
