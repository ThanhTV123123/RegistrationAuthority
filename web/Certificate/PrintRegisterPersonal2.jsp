<%-- 
    Document   : PrintRegisterPersonal2
    Created on : Jan 13, 2020, 4:15:16 PM
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function CloseDialogPrintDetail()
            {
...
//                    }
                ...
                $.ajax({
                    ...
                    url: "../PrintFormCommon",
                    data: {
                        idParam: 'printregisterpersonal2',
                        id: id,
                        sDate: global_fm_report_print_date,//getDateFooterPrint(),
                        PRINT_FULLNAME: $("#PRINT_FULLNAME").val(),
                        PRINT_ADDRESS_BILLING: $("#PRINT_ADDRESS_BILLING").val(),
                        PRINT_TAXCODE: $("#PRINT_CMND").val(),
            ...
            function popupZipWord(id, idCSRF)
            {
                ...
                $.ajax({
                    ...
                    url: "../PrintFormCommon",
                    data: {
                        idParam: 'printregisterpersonalrar2',
                        id: id,
...
//                ids = seEncript.decrypt(ids);
                ...
                if (EscapeUtils.IsInteger(ids) == true) {
                    ...
                    if (rs[0].length > 0) {
                        strPERSONAL_NAME = EscapeUtils.CheckTextNull((rs[0][0].PERSONAL_NAME));
                        PREFIX_UUID[][] sessPrefix;
                        sessPrefix = (PREFIX_UUID[][]) session.getAttribute("sessPrefixUIDPersonal");
                        strCMND = rs[0][0].PERSONAL_ID;// CommonReferServlet.filterPrefixUIDAuto(rs[0][0].PERSONAL_ID, sessPrefix);
        ...
        <div class="x_content">
            <form name="myname" method="post" class="form-horizontal">
                ...
                <input type="hidden" id="sCertTypeID" name="sCertTypeID" hidden="true" readonly="true" value="<%= String.valueOf(rs[0][0].CERTIFICATION_PURPOSE_ID)%>">
                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-sm-6" style="padding-left: 0;clear: both;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7" style="padding-right: 0px;">
                                <input type="text" name="PRINT_FULLNAME" id="PRINT_FULLNAME" value="<%=EscapeUtils.escapeHtmlDN(strPERSONAL_NAME)%>" class="form-control123">
                            </div>
                        </div>
                        <script>
                            $("#idLblTitleContactBusi").text(certlist_group_add_personal_info);
                    ...
                    <div class="col-sm-6" style="padding-left: 0;">
                        ...
                        <script>
                            $("#idLblTitlePrintCMND").text(global_fm_CMND_ID_Card);
                        </script>
                    </div>
                    <div class="col-sm-6" style="padding-left: 0;clear: both;">
                        <div class="form-group">
...
//                            });
                    ...
                    <div class="form-group" style="padding: 0px 0px 10px 0px;margin: 0;clear: both;">
                        ...
                        <script>
                            $("#idLblTitlePrintAddressBilling").text(token_fm_address_residence);
                        </script>
                    </div>
                    <div class="col-sm-6" style="padding-left: 0;clear: both;">
                        <div class="form-group">
...
////                                    $("#idLblNoteEmailReturn").text(global_fm_require_label);
//                                }
//                            });
                        </script>
                    </div>
