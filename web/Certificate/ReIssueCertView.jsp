<%-- 
    Document   : ReIssueCertView
    Created on : Jul 20, 2018, 11:52:20 AM
    Author     : THANH-PC
--%>
            ...
            function UpdateForm(idCSRF)
            {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        pNEW_TOKEN_SN: "",
                        DN: vDNResult,
                        BRANCH_ID: $("#AGENT_NAME_REISSUE").val(),
                        CREATE_USER: $("#USER_REISSUE").val(),
                    ...
                    success: function (html) {
                        ...
                        if (arr[0] === "0")
                        {
                            localStorage.setItem("EDIT_RENEWCERT_REISSUE", $("#sID").val());
                            if (arr[2] === "1"){
                                pushNotificationApprove($("#sID").val(), $("#NEW_TOKEN_SN").val());
                            }
                            funSuccAlert(certlist_succ_reissue, "RenewCertList.jsp");
                        }
    ...
    <body>
        ...
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    <%
//                        if(rs[0][0].PKI_FORMFACTOR_ID == Definitions.CONFIG_PKI_FORMFACTOR_ID_HARD_TOKEN
//                            || rs[0][0].PKI_FORMFACTOR_ID == Definitions.CONFIG_PKI_FORMFACTOR_ID_HARD_TOKEN_SAFENET
//                            || rs[0][0].PKI_FORMFACTOR_ID == Definitions.CONFIG_PKI_FORMFACTOR_ID_HARD_TOKEN_SMARTCARD)
...
//                            var sListRequire = localStorage.getItem("localListComponentEnable").split(',');
//                            console.log("localListComponentEnable " + localStorage.getItem("localListComponentEnable"));
//                            for (var i = 0; i < sListRequire.length; i++) {
//                                var item = sSpace(sListRequire[i]);
//                                console.log("A: " + item);
//                                if(item !== "") {
...
//                                            sFristCerDurationOrProfileID = String.valueOf(rsDuration[0][0].ID);
                ...
                <div class="col-sm-6" style="padding-left: 0;">
                    <div class="form-group">
                        <label id="idLblTitleAgentReissue" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;">
                        </label>
                        <div class="col-sm-7" style="padding-right: 0px;">
                            <select name="AGENT_NAME_REISSUE" id="AGENT_NAME_REISSUE" class="form-control123"
                    ...
                    <script>$("#idLblTitleAgentReissue").text(global_fm_Branch);</script>
                </div>
                <div class="col-sm-6" style="padding-left: 0px;padding-right: 0;">
                    <div class="form-group">
                        <label id="idLblTitleUserReissue" class="control-label col-sm-5" style="color: #000000; font-weight: bold;text-align: left;padding-left: 0;">
                        </label>
                        <div class="col-sm-7" style="padding-right: 0px;">
                            <select name="USER_REISSUE" id="USER_REISSUE" class="form-control123">
                                <%
                    ...
                    <script>$("#idLblTitleUserReissue").text(global_fm_user_create);</script>
                </div>
                <script>
                    function LOAD_BACKOFFICE_USER(objAgency, idCSRF)
                    {
                        $.ajax({
                            ...
                            success: function (html)
                            {
                                if (html.length > 0)
                                {
                                    var cbxUSER = document.getElementById("USER_REISSUE");
                            ...
                            success: function (html)
                            {
                                if (html.length > 0)
                                {
                                    ...
                                    if (obj[0].Code === "0")
                                    {
                                        ...
                                        var listComponentEnable = new Array();
                                            ...
                                            if(obj[i].SubjectDNAttrType === JS_STR_COMPONENT_DN_VALUE_UID_TEXT_FIELD)
                                            {
                                                ...
                                                if(obj[i].SubjectDNAttrCode === JS_STR_COMPONENT_DN_VALUE_CITYPROVINCE)
                                                {
                                                    vContent += '<div>' +
                                                        ...
                                                        '</div>' +
                                                        '</div>';
                                                    listComponentEnable.push(vInputID);
...
//                                                            $("#" + vInputID).val(sValuePushDBDataLast.replace(/###/g, ','));
                                            ...
                                            localStorage.setItem("localListComponentEnable", listComponentEnable);
...
<!--                <fieldset class="scheduler-border" style="clear: both;">
                    ...
                    <div id="idViewCSR" class="form-group" style="display: none;padding: 10px 0px 0 0px;margin: 0; clear: both;">
                        <fieldset class="scheduler-border">
                            ...
                            <script>$("#idLblTitleGroupCert").text(certlist_title_detail_old);</script>
                            <%
                                if (!"".equals(strCertificate)) {
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    ...
                    <%
                        if(CommonFunction.CheckRoleFuncValid(Definitions.CONFIG_ROLE_PROPERTIES_CERT_REISSUE,Definitions.CONFIG_ROLE_ATTRIBUTE_TYPE_CERT_REQUUEST, sessFunctionCert) == true) {
                    %>
                    <input type="button" id="btnApproveFooter" class="btn btn-info" onclick="UpdateForm('<%=anticsrf%>');" />
