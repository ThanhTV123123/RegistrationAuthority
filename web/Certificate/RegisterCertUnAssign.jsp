<%-- 
    Document   : RegisterCertUnAssign
    Created on : Aug 8, 2018, 9:09:07 AM
    Author     : THANH-PC
--%>
                            ...
                            function () {
                                ...
                                setTimeout(function () {
                                    $.ajax({
                                        ...
                                        url: "../RequestCommon",
                                        data: {
                                            idParam: 'registrationcertunassign',
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="top_nav">
                    ...
                    <script>
                        document.getElementById("idNameURL").innerHTML = regiscert_title_token_list;
                    </script>
                </div>
                                        ...
                                        <form name="myname" method="post" class="form-horizontal">
                                                    ...
                                                    <div class="col-sm-7" style="padding-right: 0px;">
                                                        <select name="CERTIFICATION_AUTHORITY" id="CERTIFICATION_AUTHORITY" class="form-control123"
                                                            ...
                                                            <option value="<%=String.valueOf(rssProfile[0][i].ID)
                                                                + "###" + EscapeUtils.CheckTextNull(rssProfile[0][i].CERTIFICATION_AUTHORITY_CORECA_SUBJECT)%>" <%= rssProfile[0][i].NAME.equals(strCADefault) ? "selected" : "" %>>
                                                                <%=rssProfile[0][i].REMARK%>
                                                            </option>
                                                            <%
                                                                            }
                                                                        }
                                            ...
                                            <div id="idDivShowFileMana" style="clear: both;">
                                                <%
                                                    ...
                                                    db.S_BO_CERTIFICATION_PURPOSE_DETAIL(sFristCerPurpose, rsPURPOSE);
