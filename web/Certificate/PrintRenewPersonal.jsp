<%-- 
    Document   : PrintRenewPersonal
    Created on : Aug 5, 2018, 10:15:56 PM
    Author     : THANH-PC
--%>
...
//                        if("".equals(strCMNDHC)) {
//                            strCMNDHC = EscapeUtils.CheckTextNull((rs[0][0].P_EID));
//                        }
//                        if("".equals(strCMNDHC)) {
//                            strCMNDHC = EscapeUtils.CheckTextNull((rs[0][0].PASSPORT));
//                        }
