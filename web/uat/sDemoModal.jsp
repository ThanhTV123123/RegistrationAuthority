    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                $('.loading-gif').hide();$('.loading-gifHardware').hide();
             });
            function CheckForm()
            {
                var idText = document.getElementById("idText").value;
                var aDate   = moment(idText, 'DD/MM/YYYY', true);
            ...
            function validateForm(signup) {
                {
                  var x = signup;//document.forms["signup"]["dateofbirth"].value;
            ...
            function checkRegDateDDMMYYYY(input)
            {
                var reg = /(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d/;
                if (input.match(reg))
                {
