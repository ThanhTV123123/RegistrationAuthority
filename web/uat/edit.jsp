<%-- 
    Document   : edit
    Created on : Mar 26, 2018, 11:07:58 AM
    Author     : THANH-PC
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function ValidateForm(idCSRF) {
                if (!JSCheckEmptyField(document.myname.BranchName.value))
                {
                    document.myname.BranchName.focus();
                    funErrorAlert(branch_req_name);
                    return false;
                }
                if (JSCheckEmptyField(document.myname.WorkPhone.value))
                {
                    if (!JSCheckFormatPhoneNew($("#WorkPhone")))
                    {
                        $("#WorkPhone").focus();
                ...
                $.ajax({
                    ...
                    data: {
                        idParam: 'editbranch',
                        id: document.myname.BranchID.value,
                    ...
                    success: function (html)
                    {
                        ...
                        if (myStrings[0] === "0")
                        {
                            funSuccAlert(_succ_edit, "BranchList.jsp");
                        }
                        ...
                        {
                            if (myStrings[1] === "1") {
                                funErrorAlert(_exists_code);
                            } else if (myStrings[1] === "2") {
                                funErrorAlert(_exists_name);
                            }
                            else {
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form name="myname" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group" style="padding: 10px 0px 0 0px;margin: 0;">
                                                <label class="control-label123"><script>document.write(global_fm_phone);</script></label>
                                                <input class="form-control123" id="WorkPhone" name="WorkPhone" maxlength="20">
                                            </div>
                                            <div class="form-group" style="padding: 10px 0px 0 0px;margin: 0;">
