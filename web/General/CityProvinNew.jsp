<%-- 
    Document   : CityProvinNew
    Created on : Feb 25, 2014, 2:57:17 PM
    Author     : Thanh
--%>
...
//                }
                ...
                $.ajax({
                    ...
                    success: function (html)
                    {
                        ...
                        if (myStrings[0] === "0")
                        {
                            funSuccAlert(city_succ_add, "CityProvin.jsp");
                        }
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><i class="fa fa-list-ul"></i> <script>document.write(city_title_add);</script></h2>
                                    ...
                                    <div class="x_content">
                                        <form name="myname" method="post" class="form-horizontal">
                                            ...
                                            <div class="form-group" style="padding: 0px 0px 0 0px;margin: 0;">
                                                <label class="control-label123"><script>document.write(city_fm_code);</script></label>
                                                <label class="CssRequireField"><script>document.write(global_fm_require_label);</script></label>
                                                <input type="text" oninput="onBlurToUppercase(this);" maxlength="64" name="citycode" class="form-control123" />
                                            </div>
                                            <div class="form-group" style="padding: 10px 0px 0 0px;margin: 0;">
                                                <label class="control-label123"><script>document.write(global_fm_Description);</script></label>
                                                <label class="CssRequireField"><script>document.write(global_fm_require_label);</script></label>
