<%-- 
    Document   : FunctionNew
    Created on : Apr 26, 2018, 5:31:57 PM
    Author     : THANH-PC
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            document.title = function_title_add;
            changeFavicon("../");
            ...
            function ValidateForm(idCSRF) {
                if (!JSCheckEmptyField(document.myname.citycode.value))
                {
                    ...
                    funErrorAlert(policy_req_empty + function_fm_code);
                    return false;
                }
                ...
                $.ajax({
                    ...
                    success: function (html)
                    {
                        ...
                        if (myStrings[0] === "0")
                        {
                            funSuccAlert(function_succ_add, "FunctionList.jsp");
                        }
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><i class="fa fa-list-ul"></i> <script>document.write(function_title_add);</script></h2>
