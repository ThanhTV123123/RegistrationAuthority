<%-- 
    Document   : CityProvin
    Created on : Feb 25, 2014, 10:51:42 AM
    Author     : Thanh
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                localStorage.setItem("LOCAL_PARAM_CITYLIST", null);
            });
            document.title = city_title_list;
            function popupEdit(id)
            {
                $('body').append('<div id="over"></div>');
                $(".loading-gif").show();
                $('#contentEdit').load('CityProvinEdit.jsp', {id:id}, function () {
                    goToByScroll("contentEdit");
                });
                $(".loading-gif").hide();
                $('#over').remove();
//                localStorage.setItem("LOCAL_PARAM_CITYLIST", id);
//                window.location = 'CityProvinEdit.jsp?id=' + id;
            }
            function addForm() {
                window.location = 'CityProvinNew.jsp';
            }
        </script>
    </head>
    <body class="nav-md">
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="top_nav">
                    ...
                    <script>
                        document.getElementById("idNameURL").innerHTML = city_title_list;
                    </script>
                </div>
                <div class="right_col" role="main">
                            ...
                            <%                                        int status = 1000;
                                ...
                                try {
                                    ...
                                    if (session.getAttribute("SessRefreshCity") != null) {
                                        ...
                                        int intCount = 0;
                                        intCount = db.S_BO_PROVINCE_TOTAL();
                                        if (intCount > 0) {
                                            ...
                                            db.S_BO_PROVINCE_LIST(sessLanguageGlobal, iPagNo, iSwRws, rsPgin);
                                        }
                                        iTotRslts = intCount;
                                    } else {
                                        ...
                                        if ((session.getAttribute("CountListCity")) == null) {
                                            intCount = db.S_BO_PROVINCE_TOTAL();
                                            session.setAttribute("CountListCity", String.valueOf(intCount));
                                        } else {
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title" style="border-bottom:none;margin-bottom:1px;">
                                        <h2><i class="fa fa-list-ul"></i> <script>document.write(city_table_list);</script></h2>
                                        ...
                                        <form name="myform" method="post" class="form-horizontal">
                                            ...
                                            <div class="table-responsive">
                                                <table id="idTableList" class="table table-bordered table-striped projects">
                                                    ...
                                                    <th><script>document.write(city_fm_code);</script></th>
                    ...
                    <script>
                        $(document).ready(function () {
                            if(localStorage.getItem("EDIT_PROVINCE") !== null && localStorage.getItem("EDIT_PROVINCE") !== "null")
                            {
                                var vIDEDIT_PROVINCE = localStorage.getItem("EDIT_PROVINCE");
