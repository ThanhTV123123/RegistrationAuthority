<%-- 
    Document   : RoseList
    Created on : Nov 18, 2019, 1:36:46 PM
    Author     : USER
--%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function popupEdit(id)
            {
                ...
                $(".loading-gif").show();
                $('#contentEdit').load('RoseEdit.jsp', {id:id}, function () {
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title" style="border-bottom: 0 solid #E6E9ED;margin-bottom: 0px;">
                                        <h2><i class="fa fa-list-ul"></i> <script>document.write(rose_title_table);</script></h2>
                                    ...
                                    <%
                                        DISCOUNT_RATE_PROFILE[][] rsPgin = new DISCOUNT_RATE_PROFILE[1][];
                                        try {
                                            ...
                                            if (session.getAttribute("SessRefreshDiscountRate") != null) {
                                                session.setAttribute("SessRefreshDiscountRate", null);
                                                int ss = db.S_BO_DISCOUNT_RATE_PROFILE_TOTAL();
                                                if (ss > 0) {
                                                    if (session.getAttribute("IPageNoSessListDiscountRate") != null) {
                                                        String sPage = (String) session.getAttribute("IPageNoSessListDiscountRate");
                                                        iPagNo = Integer.parseInt(sPage);
                                                    }
                                                    if (session.getAttribute("ISwRwsSessListDiscountRate") != null) {
                                                        String sSumPage = (String) session.getAttribute("ISwRwsSessListDiscountRate");
                                                        iSwRws = Integer.parseInt(sSumPage);
                                                    }
                                                    if (session.getAttribute("NumPageSessListDiscountRate") != null) {
                                                        String sNoPage = (String) session.getAttribute("NumPageSessListDiscountRate");
                                                        iPaNoSS = Integer.parseInt(sNoPage);
                                                    }
                                                    session.setAttribute("IPageNoSessListDiscountRate", String.valueOf(iPagNo));
                                                    session.setAttribute("ISwRwsSessListDiscountRate", String.valueOf(iSwRws));
                                                    db.S_BO_DISCOUNT_RATE_PROFILE_LIST(sessLanguageGlobal, iPagNo, iSwRws, rsPgin);
                                                }
                                                iTotRslts = ss;
                                            }
                                            else
                                            {
                                                session.setAttribute("NumPageSessListDiscountRate", null);
                                                session.setAttribute("IPageNoSessListDiscountRate", null);
                                                session.setAttribute("ISwRwsSessListDiscountRate", null);
                                                if (hasPaging != true) {
                                                    session.setAttribute("CountListDiscountRate", null);
                                                }
                                                int ss = 0;
                                                if ((session.getAttribute("CountListDiscountRate")) == null) {
                                                    ss = db.S_BO_DISCOUNT_RATE_PROFILE_TOTAL();
                                                    session.setAttribute("CountListDiscountRate", String.valueOf(ss));
                                                } else {
                                                    String sCount = (String) session.getAttribute("CountListDiscountRate");
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="table-responsive">
                                                <table id="idTableList" class="table table-bordered table-striped projects">
                                                    ...
                                                    <th><script>document.write(rose_fm_code);</script></th>
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            session.setAttribute("NumPageSessListDiscountRate", String.valueOf(iPaNoSS));
